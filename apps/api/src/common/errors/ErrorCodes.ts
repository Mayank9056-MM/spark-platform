...
export enum ErrorCode {
  ...
  ACADEMIC_HIERARCHY_MISMATCH = 'ACADEMIC_HIERARCHY_MISMATCH',
  ADMISSION_CANCELLED_PROTECTED = 'ADMISSION_CANCELLED_PROTECTED',

  STUDENT_ENROLLMENT_NOT_ACTIVE = 'STUDENT_ENROLLMENT_NOT_ACTIVE',
  STUDENT_ENROLLMENT_HAS_ACADEMIC_RECORDS = 'STUDENT_ENROLLMENT_HAS_ACADEMIC_RECORDS',
  CURRICULUM_VERSION_INVALID_TRANSITION = 'CURRICULUM_VERSION_INVALID_TRANSITION',
  SEMESTER_CATALOG_HISTORICAL = 'SEMESTER_CATALOG_HISTORICAL',
}
