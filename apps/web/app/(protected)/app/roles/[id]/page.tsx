...
import { RoleDetailCard } from '@/features/roles/components/role-detail-card';
      ...
      <div className="mx-auto max-w-xl space-y-4 py-12">
        <div className="border-destructive/30 bg-destructive/5 space-y-3 rounded-lg border p-6 text-center">
          ...
          <p className="text-muted-foreground text-xs">
            {error?.message ??
              'The requested role could not be found or you do not have permission to view it.'}
          </p>
          <Button
            size="sm"
            variant="outline"
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Role definition, system classification, and active permission grants."
      />
